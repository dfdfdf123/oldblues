(defproject oldblues "0.1.0-SNAPSHOT"

  :description "about blues"
                  ...
                  {:builds
                   {:app
                    {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
                     :figwheel {:on-jsload "oldblues.core/mount-components"}
                     :compiler
                     {:main "oldblues.app"
                      :asset-path "/js/out"
                      :output-to "target/cljsbuild/public/js/app.js"
